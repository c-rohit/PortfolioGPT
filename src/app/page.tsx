      ...
      <div className="left">
        ...
        <div className="bottom">
          <div className="description">
            <p>An enthusiastic and goal-driven Computer Science Engineer with proficient team player abilities and adequate knowledge of mainstream programming languages putting his potential to full use in the field of Software Development.</p>
          </div>
